    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="courses.html">Our Course</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted">GENERAL NURSING & MIDWIFERY</li>
        </ul>
        <p class="text-lighten">3 years. 6 days a week classes.</p>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <a href="<?php base_url();?>course-bsn" class="btn btn-primary btn-sm">Apply now</a>
      </div>
    </div>
  </div>
  <!-- course item -->
